...
const UploadRibbon = ({item, uploadImages , project_id, selectedItemId, onChangeActiveImageIndex, deleteSection, deleteImage}) => {
    ...
    return(
        <Wrapper>
            ...
            <Icon src={trash} style={{marginLeft: '15px', borderLeft: '1px solid rgb(240, 243, 244)', paddingLeft: '7px'}} onClick={() => deleteSection(item.id)} />
        </Wrapper>
    )
