...
const DropzoneArea = ({ projectId, canvasId, userId, hideButton, onUpload, children }) => {
  const { getRootProps, getInputProps, open, isDragActive, uploading } = useDropzoneDefault(
    projectId,
    canvasId,
    userId,
    onUpload,
